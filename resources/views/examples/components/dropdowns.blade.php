            ...
            <div class="flex flex-wrap gap-4">
                <div>
                    <x-ui-dropdown align="left">
                        <x-slot:trigger>
                            <button class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest">
            ...
            <div class="flex flex-wrap gap-4">
                <div>
                    <x-ui-dropdown width="w-64">
                        ...
                        <x-slot:content>
                            <div class="p-4">
                                <h3 class="text-sm font-medium text-gray-900 dark:text-white">Dropdown con contenido personalizado</h3>
                                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Este dropdown tiene un ancho personalizado y puede contener cualquier tipo de contenido.</p>
                            </div>
                        </x-slot:content>
                    </x-ui-dropdown>
                </div>
